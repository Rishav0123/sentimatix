...
```bash
scp tg_session.session ubuntu@your-ec2-ip:/home/ubuntu/sentimatix/worker-SCRAPE/stock-news/x-news/
```
...
Add this line:
```cron
0 1 * * * cd /home/ubuntu/sentimatix/worker-SCRAPE/stock-news/x-news && /usr/bin/docker compose run scraper python orchestrator.py >> /home/ubuntu/logs/cron_scrape.log 2>&1
```
