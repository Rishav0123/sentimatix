  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3 mb-2">
        <h3 className="text-white flex-1 group-hover:text-[#3B82F6] transition-colors">
          {headline}
        </h3>
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-gray-200 text-xs">{source}</span>
        <span className="text-gray-200 text-xs">•</span>
        <span className="text-gray-200 text-xs">{timestamp}</span>
      </div>
    </div>
  );
}
