...
async def portal_page():
    """Redirects to the main Sentimatix dashboard where users can manage API keys."""
    return RedirectResponse(url="https://sentimatix.onrender.com/docs")
...
if not SUPABASE_URL or not SUPABASE_KEY:
    ...
    msg = (
        ...
        "Set them in your environment or add a .env file (see apps/api/.env.example). "
