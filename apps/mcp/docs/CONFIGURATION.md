...
```bash
python -m pytest apps/mcp/test_service_key_validation.py -v
```
...
- **RAG System Logs**: `apps/mcp/logs/rag_system.log`
- **MCP Server Logs**: `apps/mcp/logs/mcp_server_YYYYMMDD.log`
