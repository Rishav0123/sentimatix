...
Start-Process powershell -ArgumentList "-NoExit", "-Command", `
    "cd d:\sentimatix\apps\api; Write-Host 'Backend API Server' -ForegroundColor Green; python server.py" `
    -WindowStyle Normal
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", `
    "cd d:\sentimatix\apps\mcp; `$env:MCP_SERVER_PORT='8001'; `$env:MCP_API_KEY='stockify-mcp-2025'; Write-Host 'MCP+RAG Server' -ForegroundColor Green; python run_server.py" `
    -WindowStyle Normal
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", `
    "cd d:\sentimatix\apps\dashboard; Write-Host 'Frontend Dev Server' -ForegroundColor Green; npm run dev" `
    -WindowStyle Normal
