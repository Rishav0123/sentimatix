...
import {
  Sparkles, ArrowUpRight, Share2, ThumbsUp, ThumbsDown, Copy,
        ...
        {msg.metadata && (
          <div className="flex gap-2 flex-wrap mb-4">
            ...
            {msg.metadata.price_change !== undefined && (
              <span className={`px-3 py-1 rounded-full text-xs font-medium ${msg.metadata.price_change >= 0
...
// --- AI SEARCH PAGE COMPONENT (for use within main layout) ---
...
export default function AISearchPage() {
  ...
  return (
    <div className="h-full w-full flex flex-col" style={{ backgroundColor: '#131314', color: 'white' }}>

      {/* Page Header */}
      <div className="border-b px-6 py-4 flex items-center justify-between" style={{ borderColor: '#2d2d2d' }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">Ask Stockify AI about stocks, markets, or news</p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          {chatHistory.length === 0 && !isSearching && (
            <div className="flex flex-col items-center justify-center min-h-[50vh] animate-fade-in">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center mb-6 shadow-2xl shadow-purple-500/30">
                <Sparkles size={40} className="text-white" />
              </div>
              <h2 className="text-3xl font-light mb-3 tracking-tight">Hello, I'm Stockify AI</h2>
              <p className="text-slate-400 text-lg mb-12">How can I help you with the markets today?</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full max-w-2xl">
                  {suggestions.map((sug, i) => (
                    <button
                      ...
                      className="p-4 rounded-xl text-left transition-all hover:scale-[1.02] group border border-gray-800 cursor-pointer"
      ...
      <div className="border-t px-6 py-4" style={{ borderColor: '#2d2d2d', backgroundColor: '#131314' }}>
        <div className="max-w-4xl mx-auto">
          <div className="relative rounded-full border" style={{ backgroundColor: '#1f1f1f', borderColor: '#3f3f3f' }}>
            <textarea
              ...
              className="w-full text-white placeholder-slate-500 px-6 py-4 pr-40 resize-none focus:outline-none text-sm leading-relaxed max-h-40 disabled:opacity-50 rounded-full"
              style={{ backgroundColor: 'transparent', minHeight: '56px' }}
            />
            ...
            <div className="absolute right-3 bottom-3 flex items-center gap-1">
              ...
              <button
                ...
                className="ml-1 p-2.5 bg-blue-600 hover:bg-blue-700 disabled:bg-slate-700 disabled:cursor-not-allowed rounded-full transition-colors text-white disabled:text-slate-500 cursor-pointer"
                title="Send"
              >
